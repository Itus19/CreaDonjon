...
export const WEAPON_ARMOR_PROFICIENCY_LABELS_FR: Record<string, string> = {
  ...
  "crossbows-heavy": "Arbalètes lourdes",
  longbows: "Arcs longs",
  nets: "Filets",
...
export const RELATION_LABELS_FR: Record<string, string> = {
  ...
  adopted_by: "adopté(e) par",
  adopted: "a adopté",
  ancestor_of: "ancêtre de",
  descendant_of: "descendant(e) de",
  partner_of: "partenaire de",
  ex_partner_of: "ancien(ne) partenaire de",
  half_sibling_of: "demi-frere/demi-sœur de",
  step_parent_of: "beau-parent de",
  step_child_of: "beau-fils/belle-fille de",
  friend_of: "ami(e) de",
  rival_of: "rival(e) de",
  mentor_of: "mentor de",
  ...
  located_in: "situé(e) dans",
  contains: "contient",
  origin_of: "origine de",
  originates_from: "originaire de",
  owns: "possède",
  owned_by: "possédé(e) par",
  created: "a créé",
  created_by: "créé(e) par",
  carries: "porte",
  carried_by: "porté(e) par",
  knows: "connaît",
  loves: "aime",
  loved_by: "aimé(e) par",
  hates: "déteste",
  hated_by: "détesté(e) par",
  participated_in: "a participé à",
  had_participant: "avec la participation de",
  witnessed: "a assisté à",
  witnessed_by: "vu par",
};
