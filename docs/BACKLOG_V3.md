...
- Le ruleset personnel : sa conception se travaille dans `docs/conception-ruleset-personnelle.md` (trous, contradictions, décisions), son contenu vit dans `data/personnel/`. Ce que le lot Q rend exprimable y est indiqué phase par phase.
