...
- [ ] **Non vérifié en direct.** Aucune fiche ne porte encore de bloc `triggers` : le chemin complet — saisir une règle, lancer un dé, la voir partir — n'a pas été observé. Demande une base locale et une fiche de test.
