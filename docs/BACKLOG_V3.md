...
- [ ] **Reste à brancher** : appeler `loadTriggersForEntries` puis `runTriggers` depuis `checkRolls.ts` et le combat. Le magasin ne bloque plus, c'est désormais du câblage.
