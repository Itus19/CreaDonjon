...
- [ ] **Les caractéristiques tiennent en deux rangées au plus.** Le pavé d'origine — six cartes bordées de trois lignes — mesure **144 px** pour six nombres, et c'est le plus gros poste de la colonne après les onglets. Trois refontes ont été dessinées dans l'esquisse, avec leur interrupteur de comparaison ; **l'auteur a retenu la barrette** le 23 septembre, complétée de la sauvegarde et du score :
...
| **Barrette** — une seule rangée de six, **retenue** | **~86 px** (−40 %) | Quatre étages par colonne, du plus durable au plus lancé : **nom, score, modificateur, sauvegarde**, chacun dans son encadré. La version comparée en cachait une moitié derrière un interrupteur ; l'auteur a demandé les deux, et l'interrupteur n'avait plus de raison d'être. Les deux étages du bas sont les boutons, 40 × 24 px chacun |
