...
- Signalé, pas commencé : les classes accordent aussi de l'équipement de départ dans le SRD (`starting_equipment`/`starting_equipment_options`, 2014 et 2024), jamais modélisé — nécessiterait un nouveau bloc de règle + une ré-ingestion de la base de production, à confirmer avant de commencer.
