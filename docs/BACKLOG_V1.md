...
- [ ] Traduire Objet et Aptitude en tenant compte de la nouvelle structure post-V1-A2 (Objet 30 % → **67 %**, Aptitude 28 % → **62 %** — catégories les plus volumineuses, 1169 et 961 entrées, en net progrès mais pas finies).
