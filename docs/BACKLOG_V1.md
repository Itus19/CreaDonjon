...
| Aptitude (`feature`) | **328/348** | **436/636** |
| Sort | 319/319 | **319/319** |
| Arme | **37/37** | **41/41** |
| Armure | 13/13 | **13/13** |
| Objet | **472/549** | 432/620 |
| Monstre | **334/334** (333/334 avec `traits`/`actions`) | 324/334 (plafond probable ~324, voir point 10) |
...
9. ~~**Rapport de couverture final et clôture.**~~ **Fait le 13 août (deuxième session).** Comptes revérifiés en base pour tous les types, sur les deux rulesets, avec la distinction traduit / plafond structurel documenté / restant réellement ouvert :
   ...
   |---|---|---|---|---|
   | Espèce (noms) | 13/13 | atteint | 24/39 | non retraité — 15 manquants déjà vérifiés bloqués (tableaux Draconic Ancestor/Elven Lineage, ou espèces hors SRD 2024, point 1) |
   ...
   | Aptitude (noms) | 328/348 | **plafond structurel** — 20 manquants = couleurs Ascendance/Ancêtre draconique, table à deux colonnes sans expression combinée | 436/636 | non retraité (vocabulaire 2024 propre, point 5) |
   ...
   | Objet (noms) | 472/549 | **plafond structurel** — 76 confirmés bloqués (tables à valeur unique, point 6) + 1 confirmé bloqué (`sprig-of-mistletoe`, simple exemple de prose sans en-tête propre) ; aucun autre candidat trouvé après recherche par contenu mécanique | 432/620 | non retraité |
