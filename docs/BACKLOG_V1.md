...
*Également hors périmètre : supprimer une variante — aucune route de suppression n'existe pour `rulesets` (une variante créée par erreur reste en base, inoffensive puisqu'invisible tant qu'elle n'est pas choisie comme active). À construire si le besoin se confirme.*
